    ...
    private class LableDetectionTask extends AsyncTask<Object, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (activity != null && !activity.isFinishing()) {
                ...
                for(String text : texts) {
                    if(text.length() <= 2 || has_hangul(text) == true) continue;

                    String ssid = get_ssid(text);
                    String key = get_key(text);
...
//remember id
    ...
    public static String get_ssid(String text) {
    ...
    public static boolean has_hangul(String text) {
